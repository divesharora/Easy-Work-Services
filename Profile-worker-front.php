...
<head>
    ...
    <script>
        $(document).ready(function(){
            $("#btnFetchProfileWorker").click(function(){
                var uid=$("#txtUid").val();
                   ...
                   /* alert(JSON.stringify(JsonAryResponse));*/
                    if(JsonAryResponse.length==0)
                    ...
                    else
                        {
                            ...
                            $("#txtName").val(JsonAryResponse[0].workername);
                            ...
                            $("#txtSpl").val(JsonAryResponse[0].specialization);
                            $("#txtExperience").val(JsonAryResponse[0].experience);
           ...
           <input type="hidden" id="hdn2" name="hdn2">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" class="form-control" id="txtExperience" name="txtExperience">
                </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-row">
               <div class="col-md-12">
                ...
                <br>
                <textarea class="col-md-12" rows="10" cols="30" id="txtotherinfo" name="txtotherinfo">The cat was playing in the garden.</textarea>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-6">
