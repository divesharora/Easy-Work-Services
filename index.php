            ...
            <div id="overall-div">
                <div id="nav-top">
                    <nav class="navbar navbar-expand-lg navbar-light" id="NavBar" style="background-color:transparent;">
                        <a id="nav-logo" href="#" style="color:Black;">Manpowerservices.com</a>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Pics/CROUSELIMG.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Pics/crouseliamge3.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Pics/crouselimage4.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
                ...
                <center>
                   <div id="developer-div" class="row">
                    <div class="col-md-8">
                        <div class="card mb-3" >
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="Pics/Kheman.jpg" class="card-img" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body table-responsive">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th >College</th>
                                                    <td>Vellore Insitute of Technology</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="https://www.linkedin.com/in/kheman"><i class="fa fa-linkedin-square" aria-hidden="true" style="font-size:30px;"></i>https://www.linkedin.com/in/kheman</a></td>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body table-responsive">
                                        ...
                                        <table class="table">
                                                ...
                                                <tr>
                                                    <th >Owner At</th>
                                                    <td>Banglore Computer Education Bathinda &nbsp;&nbsp;<a href="https://goo.gl/maps/s985E8Ea6x9NmwjJ7" style="font-size:30px;"><i class="fa fa-map-marker" aria-hidden="true"></i></a></td>
                                                ...
                                                <tr>
                                                    <th >Linkedin Profile</th>
                                                    <td><a href="https://www.linkedin.com/in/rajesh-scjp-bansal-8a87251a"><i class="fa fa-linkedin-square" aria-hidden="true" style="font-size:30px;"></i>   https://www.linkedin.com/in/rajesh-scjp-bansal-8a87251a</a></td>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="RadCitizen" name="RadSignup" value="Citizen"> Citizen
                                <input type="radio" id="RadWorker" name="RadSignup" value="Worker"> Worker
                            </div>
